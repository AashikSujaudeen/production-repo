...
logging.basicConfig(level=logging.DEBUG, filename='logfile_training.txt')
...
model = create_model(vocab_size, TOP_N_TAGS, embedding_matrix, 'glorot_uniform', [0.20, 0.30])
