...
import numpy as np
import logging
logging.basicConfig(level=logging.DEBUG, filename='logfile_Precprocessing.txt')
nltk.download('punkt')
...
TRAIN = 'Train.csv'
TEST = 'Test.csv'
CHUNK_SIZE = 250000 # 0.5 million observations w.r.t. my machine capacity
...
# Parameters Needed for Data preprocessing
MAX_SEQ_LENGTH = 400
TOP_N_TAGS = 500
